...
public class AutoPointApiHelper {
    ...
    public static String getPointerApiUrl(String apiPath) {
        ...
        AutoPointer.SERVER_ENV serverEnv = AutoPointer.getServerEnv();
        DDLogger.d(AutoPointer.TAG, "环境:" + serverEnv);
