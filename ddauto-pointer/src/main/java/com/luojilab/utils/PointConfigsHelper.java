...
public class PointConfigsHelper {
    public static final String TAG = AutoPointer.TAG;

    private static PointConfigsHelper sConfigsHelper;

    private static final File CACHE_DIR = AutoPointerInitializer.getInstance().getAppContext().getExternalCacheDir();
